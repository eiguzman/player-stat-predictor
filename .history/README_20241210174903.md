...
---
## Model 1
We started by implementing a simple LienarRegression from SKlearn implementation of LinearRegression using `TRB_per_game`, `AST_per_game`, `MP_per_game`, `FGA_per_game`, `3PA_per_game`, `2PA_per_game`, `FTA_per_game`,`Age`
...
`TRB_per_game`, `AST_per_game`, `MP_per_game`, `FGA_per_game`, `3PA_per_game`, `2PA_per_game`, `FTA_per_game`, `WS`, `BPM`, `PER`, `VORP`, and `Age`
...
To get a basic relation of our target(`PPG`) and other features we did a simple plot against each other.
![alt text](./Imgs/Data%20Explolration/plot.png)
